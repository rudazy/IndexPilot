...
// Layered dark base: radial wash, skewed cyan streaks, noise texture, and a
// fine dot grid. Used as the bottom layer of the site-wide background.
  ...
  return (
    <div className={cn("relative min-h-screen w-full overflow-hidden bg-black", className)}>
      <div className="absolute inset-0">
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(rgba(40, 56, 92, 0.5) 0%, rgba(40, 56, 92, 0) 100%)",
      ...
      <div
        ...
        style={{
          backgroundImage: 'url("/textures/dark-pattern-noise.png")',
